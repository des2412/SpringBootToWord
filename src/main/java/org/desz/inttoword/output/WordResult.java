...
public class WordResult {
	...
	public static class Builder {
		...
		private static Pattern p1 = Pattern.compile("(?i:.*" + UkPair.ZERO.getWord() + ".*)");
		private static Pattern p2 = Pattern.compile("(?i:.*" + DePair.ZERO.getWord() + ".*)");
		private static Pattern p3 = Pattern.compile("(?i:.*" + NlPair.ZERO.getWord() + ".*)");
		private static Pattern p4 = Pattern.compile("(?i:.*" + FrPair.ZERO.getWord() + ".*)");
